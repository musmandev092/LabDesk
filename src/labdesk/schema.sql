...
CREATE TABLE IF NOT EXISTS tests (
    ...
    -- optional render-layout override; NULL ⇒ classify at render time from the
    -- parameters (see labdesk.catalog_render). One of: numeric_tabular |
    -- qualitative | descriptive | culture.
    render_category TEXT,
    active          INTEGER NOT NULL DEFAULT 1
);
...
-- Legacy qualitative tags also occur in the shipped catalog and are treated as a
-- normal result line by the renderer: N/P (pos/neg), N/R (reactive/non-reactive),
-- VIR / HIV (serology), B (molecular sub-step). C = conclusion/impression line.
...
CREATE TABLE IF NOT EXISTS receipt_items (
    ...
    conclusion  TEXT,                   -- impression/interpretation (imaging, molecular)
