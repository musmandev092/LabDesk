...
def _patient_card(d: Doc, x, y, pairs, *, card_pad=(5, 6), gap=(4, 6),
                  l_pt=7.5, v_pt=9.5, radius=6, border=BORDER2):
    """4-column patient card. Returns its total height in mm."""
    cols = 4
    ...
    cell_h = l_h + 0.6 + v_h
    card_h = 2 * pv + rows * cell_h + (rows - 1) * gv
